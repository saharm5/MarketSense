...
// // //   onTempToggleFundType(fundType: number) {
// // //     const index = this.tempSelectedFundTypes.indexOf(fundType);
// // //     if (index === -1) {
// // //       this.tempSelectedFundTypes.push(fundType);
// // //     } else {
// // //       this.tempSelectedFundTypes.splice(index, 1);
// // //     }
// // //   }
...
// // //       .filter((item) => this.selectedFundTypes.includes(item.fundType))
// // //       .map((item) => {
// // //         const dailyEff = item.custom?.dailyEfficiency ?? 0;
...
// // //         },
// // //         formatter: function () {
// // //           const c = (this as any).point.custom || {};
// // //           const format = (n: number | undefined | null) =>
// // //             typeof n === 'number' ? n.toLocaleString('fa-IR') : '---';
// // //           const percent = (n: number | undefined | null) =>
// // //             typeof n === 'number' ? `${n.toFixed(2)}%` : '---';

// // //           if ((this as any).point.parent) {
// // //             return `
// // //               <div>
// // //                 <b>📌 ${(this as any).point.name}</b><hr/>
// // //                 <div><b>مدیر:</b> ${c.manager || '---'}</div>
// // //                 <div><b>نوع سرمایه‌گذاری:</b> ${c.typeOfInvest || '---'}</div>
// // //                 <div><b>قیمت صدور:</b> ${format(c.issueNav)}</div>
// // //                 <div><b>قیمت ابطال:</b> ${format(c.cancelNav)}</div>
...
// // //                   '{point.custom.monthlyEfficiency}</span>',
// // //                 style: {
// // //                   color: 'white',
// // //                 },
// // //               },
...
// // //   // ✅ متغیرها برای فیلتر نهایی و موقت:
// // //   selectedFundTypes: number[] = [4, 6, 7];
// // //   tempSelectedFundTypes: number[] = [];
...
// // //         // ✅ مقداردهی اولیه به tempSelectedFundTypes
// // //         this.tempSelectedFundTypes = [...this.selectedFundTypes];
...
// // //   // ✅ تابع فقط لیست موقت را تغییر می‌دهد
// // //   onTempToggleFundType(fundType: number) {
// // //     const index = this.tempSelectedFundTypes.indexOf(fundType);
// // //     if (index === -1) {
// // //       this.tempSelectedFundTypes.push(fundType);
...
// // //   // ✅ فقط با کلیک روی دکمه، اعمال می‌شود
// // //   applySelectedFundTypes() {
// // //     this.selectedFundTypes = [...this.tempSelectedFundTypes];
// // //     this.filterData();
// // //   }
...
//   ngOnInit() {
//     // مقداردهی اولیه داده‌ها بدون استفاده از Highcharts
//     this.allCategories = [...this.parentCategories];
//     this.tempSelectedFundTypes = [...this.selectedFundTypes];
//   }

//   ngAfterViewInit() {
//     // فقط در مرورگر، ماژول treemap را بارگذاری و نمودار را آماده می‌کنیم
//     if (isPlatformBrowser(this.platformId)) {
...
//         })
//         .catch((err) => {
//           console.error('خطا در بارگذاری ماژول Highcharts treemap:', err);
//         });
//     }
//   }
...
//   onTempToggleFundType(fundType: number) {
//     if (this.tempSelectedFundTypes.includes(fundType)) {
//       this.tempSelectedFundTypes = this.tempSelectedFundTypes.filter(
//         (ft) => ft !== fundType
//       );
//     } else {
//       this.tempSelectedFundTypes.push(fundType);
